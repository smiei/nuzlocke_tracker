...
| `2.0`, `2.1`, … | An exact, immutable build. Pin one of these if you want to be able to go back. |
...
```
gloryy/nuzlocke-tracker:latest   →   gloryy/nuzlocke-tracker:2.0
```
