...
INSERT INTO "new_Encounter" ("createdAt", "currentPokemonId", "familyId", "id", "isStatic", "nickname", "player", "pokemonId", "routeId", "runId", "shiny", "soulLinkId", "status", "updatedAt") SELECT "createdAt", "currentPokemonId", "familyId", "id", "isStatic", "nickname", "player", "pokemonId", "routeId", "runId", "shiny", "soulLinkId", "status", "updatedAt" FROM "Encounter";
