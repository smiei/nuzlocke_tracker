...
CREATE TABLE "new_Encounter" (
    ...
    "soulLinkId" INTEGER,
    "fusedIntoId" INTEGER,
    "isFusionBody" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Encounter_fusedIntoId_fkey" FOREIGN KEY ("fusedIntoId") REFERENCES "Encounter" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
...
INSERT INTO "new_Encounter" ("createdAt", "currentPokemonId", "familyId", "fusedIntoId", "id", "isStatic", "nickname", "player", "pokemonId", "routeId", "runId", "shiny", "soulLinkId", "status", "updatedAt") SELECT "createdAt", "currentPokemonId", "familyId", "fusedIntoId", "id", "isStatic", "nickname", "player", "pokemonId", "routeId", "runId", "shiny", "soulLinkId", "status", "updatedAt" FROM "Encounter";
DROP TABLE "Encounter";
ALTER TABLE "new_Encounter" RENAME TO "Encounter";
CREATE UNIQUE INDEX "Encounter_fusedIntoId_key" ON "Encounter"("fusedIntoId");
